...
const taskFormObjs = (() => {
  ...
  const taskFormPrioritySelectObj = (taskPriority=null) => {
    return formObjs.prioritySelectObj(context, formType, taskPriority, 'priority',['Urgent','High','Medium','Low','None'])
  } 
  const taskFormTitleInputObj = (taskTitle=null) => { 
    return formObjs.textInputObj(context, formType, taskTitle, 'title', 'Task Title', true)
  }
